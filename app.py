...
st.set_page_config(page_title="León-Builder", layout="centered")
...
# --- VISUALIZACIÓN DE PNL SIMULADO ---
st.markdown("---")
st.subheader("📈 Simulación de Laboratorio")
...
if st.button("🚀 ENVIAR AL SERVIDOR DELL"):
    st.balloons()
    st.success("Configuración enviada. El León está analizando...")
